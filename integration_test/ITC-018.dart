...
void main() {
  ...
  group('ITC-018: Test integration between motivational quotes and home dashboard.', () {
    ...
    testWidgets('Motivational quotes display dynamically upon dashboard load.', (tester) async {
      await app.testMain();
      await tester.pumpAndSettle();
