...
import '../../controllers/counselor_first_setup_controller.dart';

class CounselorFirstSetup extends StatefulWidget {
  const CounselorFirstSetup({super.key});

  @override
  State<CounselorFirstSetup> createState() => _CounselorFirstSetupState();
}

class _CounselorFirstSetupState extends State<CounselorFirstSetup> {
  final _formKey = GlobalKey<FormState>();
  final _firstNameController = TextEditingController();
  final _lastNameController = TextEditingController();
  final _emailController = TextEditingController();
  final _bioController = TextEditingController();
  final _controller = CounselorFirstSetupController();
  ...
  Future<void> _loadExistingProfile() async {
    ...
    try {
      ...
      final result = await _controller.loadExistingProfile(user.id);
