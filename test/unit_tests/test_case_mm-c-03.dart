...
class MockChatDatabase {
  ...
  DateTime _fakeNow = DateTime(2025, 1, 1);
  ...
  void storeMessage(String userId, String messageContent, String sender) {
    ...
    messages.add({
      ...
      'sender': sender,
      'created_at': _fakeNow.toIso8601String(),
    });
    // Increment fake time by one second to guarantee order
...
void main() {
  group('MM-C-03: Chat message send and retrieve', () {
